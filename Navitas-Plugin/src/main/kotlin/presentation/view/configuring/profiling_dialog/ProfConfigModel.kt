...
import presentation.view.configuring.profiling_dialog.steps.AndroidModuleChoosingStep
import presentation.view.configuring.profiling_dialog.steps.InstrumentedTestChoosingStep
import tooling.AndroidModuleProvider

class ProfConfigModel(
        project: Project
) : WizardModel("Profiling configuration") {
    ...
    private val androidModules: List<Module> = provider.fetchAndroidModuleList().filter { module ->
