    ...
    fun selectMethod(item: CpuMethodEnergyConsumption?) {
        ...
        if (item == null) {
            ...
            for (child in getCurrentExternalMethods()) {
                items.add(EnergyConsumption(child.methodName, child.cpuEnergy, Float.NaN, Float.NaN, Float.NaN, Float.NaN))
            }
        } else {
            ...
            items.add(EnergyConsumption(item.methodName, remainder, Float.NaN, Float.NaN, Float.NaN, Float.NaN))
        }
